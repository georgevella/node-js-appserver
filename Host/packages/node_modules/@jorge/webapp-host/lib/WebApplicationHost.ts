...
export class WebApplicationHost implements IWebApplicationHost {
     ...
     *
     */
    public constructor(@Inject(TServiceProvider) private serviceProvider: IServiceProvider) {
    ...
    public extend(parent: express.Application) {
        parent.use('/', this.mainApplication);
    }
