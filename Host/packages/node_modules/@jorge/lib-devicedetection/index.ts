...
import { TDeviceDetection } from "./lib/symbols" 
import { SniffrDeviceDetectionService } from "./lib/SniffrDeviceDetectionService"

export class DeviceDetectionModule implements di.IModule
{
  registerServices(container: di.ContainerConfiguration): void {
    container.registerSingleton(TDeviceDetection, SniffrDeviceDetectionService);
  }  
}
